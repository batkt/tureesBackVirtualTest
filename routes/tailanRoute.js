...
const { borluulaltiinTailanAvya, avlagiinTailanAvya, avlagiinChartSalbaraarAvya, orlogiinChartSalbaraarAvya,
    orlogiinChartSalbarKhugatsaagaarAvya, zardaliinTailanAvya, ashigiinTailanAvya, analitikTailanAvya } = require("../controller/tailan");
...
router.route("/orlogiinChartSalbarKhugatsaagaarAvya").post(tokenShalgakh, orlogiinChartSalbarKhugatsaagaarAvya);
