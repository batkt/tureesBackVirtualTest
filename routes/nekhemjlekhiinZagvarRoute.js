...
router.route("/excelTalbaruud").get(tokenShalgakh, async (req, res, next) => {
  try {
    const ashiglaltiinZardluud = req.params.ashiglaltiinZardluud;
    var songokhTalbaruud = [];
    songokhTalbaruud.concat(
      undsenTalbaruud,
