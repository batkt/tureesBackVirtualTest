...
router.get(
  "/zogsoolJagsaalt",
  tokenShalgakh,
  uilchluulegchController.zogsoolJagsaalt,
);
router.post(
  "/zogsoolUstgay",
  tokenShalgakh,
  uilchluulegchController.zogsoolUstgah,
);
router.post(
  "/zogsoolOrlogoGaraas",
  tokenShalgakh,
  uilchluulegchController.orlogoGaraas,
);
router.post(
  "/zogsooliinTulburTulye",
  tokenShalgakh,
  uilchluulegchController.tulburTulye,
);
router.post(
  "/uilchluulegchTseverliy",
  tokenShalgakh,
  uilchluulegchController.tseverliy,
);
router.post(
  "/uilchluulegchUstgay",
  tokenShalgakh,
  uilchluulegchController.ustgah,
);
router.post(
  "/zogsoolUilchluulegchdiinToo",
  tokenShalgakh,
  uilchluulegchController.tooAvya,
);
router.post(
  "/zogsoolTusBurUilchluulegchdiinToo",
  tokenShalgakh,
  uilchluulegchController.tusBuriinTooAvya,
);
router.post("/zogsoolSdkService", tokenShalgakh, zogsoolSDK.zogsoolSdkService);
router.post(
  "/zogsooliinTulburOrjIrlee",
  zogsooliinTulburController.tulburOrjIrlee,
);
router.post(
  "/zogsooliinAjiltniiUdriinTailanAvya",
  tokenShalgakh,
  zogsoolTailanController.ajiltniiUdriinTailan,
);
router.post(
  "/zogsooliinUdriinTailanAvya",
  tokenShalgakh,
  zogsoolTailanController.udriinTailan,
);
router.post(
  "/zogsoolUilchluulegchdiinDunAvay",
  tokenShalgakh,
  zogsoolTailanController.zogsoolUilchluulegchdiinDunAvay,
);
router.get(
  "/zogsooliinIpAvaya/:barilgiinId",
  tokenShalgakh,
  parkingController.getZogsooliinIpAvaya,
);
router.post(
  "/mashiniiTooAvya",
  tokenShalgakh,
  parkingController.mashiniiTooAvya,
);
router.get("/v1/parking", parkingController.getParkingV1);
router.post(
  "/tsenegleltKhiiy",
  tokenShalgakh,
  tsenegleltController.tsenegleltKhiiy,
);
router.get("/pass/zogsool", tokenShalgakh, passController.getPassZogsool);
router.get(
  "/pass/mashinKhaikh/:dugaar",
  tokenShalgakh,
  passController.mashinKhaikh,
);
...
router.get(
  "/v1/search_car_unegui/:plate_number",
  tokenShalgakh,
  parkingUneguiController.searchCarUnegui,
);
...
router.post(
  "/v1/kioskEbarimtAvya",
  tokenShalgakh,
  kioskEbarimtController.kioskEbarimtAvya,
);
router.post("/mashinUpdate", tokenShalgakh, mashinController.mashinUpdate);
router.post(
  "/turluurZogsoolIdOruulakh",
  tokenShalgakh,
  busadDataZogsoolController.turluurZogsoolIdOruulakh,
);
router.post(
  "/ebarimtAvsanDunOruulakh",
  tokenShalgakh,
  busadDataZogsoolController.ebarimtAvsanDunOruulakh,
);
router.post(
  "/davkharBarimtZasakh",
  tokenShalgakh,
  busadDataZogsoolController.davkharBarimtZasakh,
);
router.post(
  "/niitZurchilteiMashinOlokh",
  tokenShalgakh,
  zogsoolZurchilteiContoller.niitZurchilteiMashinOlokh,
);
router.post(
  "/zurchilteiMashinMsgilgeekh",
  tokenShalgakh,
  zogsoolZurchilteiContoller.zurchilteiMashinMsgilgeekh,
);
router.post(
  "/zurchiluudTulsunBolgoy",
  tokenShalgakh,
  zogsoolZurchilteiContoller.zurchiluudTulsunBolgoy,
);
router.post(
  "/zogsooliinTuluuguiMashiniiTailanAvya",
  tokenShalgakh,
  zogsoolZurchilteiContoller.zogsooliinTuluuguiMashiniiTailanAvya,
);
router.get("/notTokiParking", notTokiParkingController.notTokiParking);
router.post(
  "/dotorZogsoolDavhkardsanMashin",
  tokenShalgakh,
  dotorZogsoolController.dotorZogsoolDavhkardsanMashin,
);
router.post(
  "/zochinAjiltaniiIdTseverlekh",
  notTokiParkingController.zochinAjiltaniiIdTseverlekh,
);
router.post(
  "/mashiniiDugaarZasakh",
  tokenShalgakh,
  mashinController.mashiniiDugaarZasakh,
);
router.post(
